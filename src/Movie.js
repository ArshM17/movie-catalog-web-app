...
import { faHeart , faStar, faV } from '@fortawesome/free-solid-svg-icons';
...
export default function Movie( {movie} ) {
  ...
  return (
    <div className="movie">
        ...
        <span className="heart" onClick={()=>handleLike(movie.id)} style={styles}><FontAwesomeIcon icon={faHeart}></FontAwesomeIcon></span>
        <div className="info">
